...
export const resources = [
...

  {
    ...
    difficulty: 'Higher',
    gcseTier: ['higher'],
    description: 'Find the original amount before a percentage increase or decrease was applied.',
    keywords: ['reverse percentage', 'original amount', 'before the sale', 'undo a percentage'],
    videoId: '',
    videoLength: '5 min',
    guide: {
      summary: 'Divide by the multiplier, rather than multiplying by it, to undo a percentage change.',
      paragraphs: [
        'Reverse percentage questions give you the amount after an increase or decrease and ask you to find the original amount.',
        'Work out the multiplier as usual, but this time divide the given amount by the multiplier instead of multiplying.',
        'Always check your answer makes sense — the original amount should be smaller than the new amount if there was an increase, and larger if there was a decrease.',
      ],
      workedExample: {
        question: 'After a 20% increase, a price is £96. Find the original price.',
        steps: [
          'The multiplier for a 20% increase is 1.2',
          'Divide: £96 ÷ 1.2 = £80',
        ],
        answer: '£80',
      },
    },
    commonMistake: 'Finding 20% of £96 and subtracting it — this does not undo the increase correctly because the 20% was originally calculated from a different (smaller) amount.',
    practiceQuestions: [
